        ...
        rows.append(
            {
                ...
                "abs_auc_minus_half": "" if auc is None else abs(auc - 0.5),
                "mcc_top10pct": mcc_at_top_fraction(y, s, 0.1),
                "recall_pos_at_top10pct": "" if rec10 is None else rec10,
                "recall_pos_at_top1pct": "" if rec01 is None else rec01,
            }
        )
    return rows
