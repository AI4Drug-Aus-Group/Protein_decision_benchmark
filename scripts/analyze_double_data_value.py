    ...
    for path in paths:
        ...
        with path.open(newline="", encoding="utf-8") as fh:
            for row in csv.DictReader(fh):
                ...
                out[key] = {
                    "spearman_doubles": parse_float(row.get("spearman_doubles", "")),
                    "spearman_higher": parse_float(row.get("spearman_higher", "")),
                    "spearman_all": parse_float(row.get("spearman_all", "")),
                    "top1pct_recall_at_100": parse_float(row.get("top1pct_recall_at_100", "")),
                }
    return out
...
def main() -> None:
    ...
    parser.add_argument(
        "--inputs",
        default="results/low_n/low_n_calibration_top20_nongiant_metrics.csv,results/low_n/low_n_supervised_baselines_nongiant_metrics.csv,results/low_n/low_n_multi_zscore_ridge_nongiant_metrics.csv",
    )
    ...
    for (budget, model, method), records in deltas.items():
        metric_counts = {
            metric: sum(f"delta_{metric}" in record for record in records)
            for metric in [
                "spearman_doubles",
                "spearman_higher",
                "spearman_all",
        ...
        summary_rows.append(
            {
                ...
                "method": method,
                "n_pairs": len(records),
                "n_pairs_spearman_doubles": metric_counts["spearman_doubles"],
                "n_pairs_spearman_higher": metric_counts["spearman_higher"],
                "n_pairs_spearman_all": metric_counts["spearman_all"],
                "n_pairs_top1pct_recall_at_100": metric_counts[
                    "top1pct_recall_at_100"
                ],
                "mean_delta_spearman_doubles": mean(r["delta_spearman_doubles"] for r in records if "delta_spearman_doubles" in r),
                "mean_delta_spearman_higher": mean(r["delta_spearman_higher"] for r in records if "delta_spearman_higher" in r),
                "mean_delta_spearman_all": mean(r["delta_spearman_all"] for r in records if "delta_spearman_all" in r),
                "mean_delta_top1pct_recall_at_100": mean(r["delta_top1pct_recall_at_100"] for r in records if "delta_top1pct_recall_at_100" in r),
            }
        )
    ...
    fields = [
        ...
        "method",
        "n_pairs",
        "n_pairs_spearman_doubles",
        "n_pairs_spearman_higher",
        "n_pairs_spearman_all",
        "n_pairs_top1pct_recall_at_100",
        "mean_delta_spearman_doubles",
        "mean_delta_spearman_higher",
        "mean_delta_spearman_all",
        "mean_delta_top1pct_recall_at_100",
    ]
