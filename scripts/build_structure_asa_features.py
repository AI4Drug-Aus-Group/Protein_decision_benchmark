...
def main() -> None:
    ...
    for meta in meta_rows:
        ...
        base = {
            ...
            "n_variants_with_coords": 0,
            "n_mutated_positions_with_coords": 0,
            "mean_neighbor_count_10A": "",
            "mean_exposed_fraction": "",
            "mean_buried_fraction": "",
            "single_mean_neighbor_count_10A": "",
            "single_exposed_fraction": "",
            "single_buried_fraction": "",
            "multi_mean_neighbor_count_10A": "",
            "multi_exposed_fraction": "",
            "multi_buried_fraction": "",
        }
        ...
        coords = align_coords(
            parse_ca(pdb_path), target_positions, meta.get("pdb_range", "")
        )
        ...
        rec.update(
            {
                "n_variants_with_coords": len(all_counts),
                "n_mutated_positions_with_coords": len(pos_seen),
                "mean_neighbor_count_10A": safe_mean(all_counts),
                "mean_exposed_fraction": safe_mean(all_exposed),
                "mean_buried_fraction": safe_mean(all_buried),
                "single_mean_neighbor_count_10A": safe_mean(single_counts),
                "single_exposed_fraction": safe_mean(single_exposed),
                "single_buried_fraction": safe_mean(single_buried),
                "multi_mean_neighbor_count_10A": safe_mean(multi_counts),
                "multi_exposed_fraction": safe_mean(multi_exposed),
                "multi_buried_fraction": safe_mean(multi_buried),
            }
        )
        rows.append(rec)
