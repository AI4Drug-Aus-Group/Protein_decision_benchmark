    ...
    for assay, rows in by_assay.items():
        ...
        for row in rows:
            rec = {
                "assay": assay,
                "mutant": row["mutant"],
                "score_double": row["score_double"],
                "additive_prediction": row["additive_prediction"],
                "epistasis_residual": row["epistasis_residual"],
                "abs_epistasis_residual": row["abs_epistasis_residual"],
                "reciprocal_sign_epistasis_candidate": "1",
            }
