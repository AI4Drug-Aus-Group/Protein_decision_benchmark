            ...
            rows.append(
                {
                    ...
                    "assay_type_keyword": assay_type_from_name(row["assay"]),
                    "mutation_stratum": mutation_stratum,
                    "double_density": double_density,
                    "epistasis_stratum": epi_stratum,
                    "mean_abs_epistasis_residual": "" if epi is None else epi,
