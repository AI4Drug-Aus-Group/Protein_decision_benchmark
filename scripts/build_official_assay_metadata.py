...
def main() -> None:
    ...
    for assay_row in manifest:
        ...
        curation_rows.append(
            {
                "assay": assay,
                "protein_key": assay_row["protein_key"],
                "assay_type": official_type,
                "assay_type_official": official_type,
                "selection_assay": ref.get("selection_assay", ""),
                "selection_type": ref.get("selection_type", ""),
                "coarse_selection_type": ref.get("coarse_selection_type", ""),
                "molecule_name": ref.get("molecule_name", ""),
                "raw_DMS_phenotype_name": ref.get("raw_DMS_phenotype_name", ""),
                "raw_DMS_directionality": ref.get("raw_DMS_directionality", ""),
                "title": ref.get("title", ""),
                "first_author": ref.get("first_author", ""),
                "year": ref.get("year", ""),
                "jo": ref.get("jo", ""),
                "taxon": ref.get("taxon", ""),
                "source_organism": ref.get("source_organism", ""),
                "MSA_N_eff": ref.get("MSA_N_eff", ""),
                "MSA_Neff_L": ref.get("MSA_Neff_L", ""),
                "MSA_Neff_L_category": ref.get("MSA_Neff_L_category", ""),
                "pdb_file": ref.get("pdb_file", ""),
                "pdb_range": ref.get("pdb_range", ""),
