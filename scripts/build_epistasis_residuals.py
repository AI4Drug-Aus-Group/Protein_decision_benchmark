        ...
        rows.append(
            {
                ...
                "single_b": parts[1],
                "score_double": y,
                "score_single_a": single_scores[parts[0]],
                "score_single_b": single_scores[parts[1]],
                "wt_proxy": wt_proxy,
                "additive_prediction": additive,
                "epistasis_residual": residual,
                "abs_epistasis_residual": abs(residual),
                "sign_epistasis_candidate": int(
                    (single_scores[parts[0]] - wt_proxy) * (y - single_scores[parts[1]]) < 0
                    or (single_scores[parts[1]] - wt_proxy) * (y - single_scores[parts[0]]) < 0
                ),
            }
        )
...
def main() -> None:
    ...
    fieldnames = [
        ...
        "additive_prediction",
        "epistasis_residual",
        "abs_epistasis_residual",
        "sign_epistasis_candidate",
    ]
