...
def ci_added() -> None:
    ...
    configs = [
        (
            ROOT / "results" / "epistasis" / "epistatic_uncertainty_enrichment_detail.csv",
            ["score", "k"],
            ["high_abs_residual_enrichment", "positive_residual_enrichment", "sign_epistasis_enrichment"],
        ),
        (
            ROOT / "results" / "double_data_value" / "informative_double_selection_heldout_detail.csv",
            ["selection_policy", "budget", "epistasis_bin"],
            ["delta_spearman", "delta_top1pct_recall"],
        ),
        (
            ROOT / "results" / "zero_shot" / "zero_shot_extended_metrics.csv",
            ["method"],
            ["pearson", "top20_enrichment_top1pct", "top10_enrichment_top1pct"],
        ),
    ]
